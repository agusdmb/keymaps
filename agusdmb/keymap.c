...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   // ---------------, ------------, ------------,  ------------,  --------------, --------------------, ------------, ------------, ------------, ------------, ------------, ------------,
    ...
    KC_LSFT,        KC_LCTL,      KC_LALT,       KC_NO,         KC_NO,          KC_NO,                KC_HOME,      KC_PGDN,      KC_PGUP,      KC_END,       KC_NO,        KC_LALT,
    ...
    KC_NO,          KC_NO,        KC_MUTE,       KC_VOLD,       KC_VOLU,        KC_PSCR,              KC_MINS,      KC_EQL,       KC_LBRC,      KC_RBRC,      KC_BSLS,      KC_GRV,
    KC_LSFT,        KC_LCTL,      KC_LALT,       KC_BRID,       KC_BRIU,        KC_NO,                KC_UNDS,      KC_PLUS,      KC_LCBR,      KC_RCBR,      KC_PIPE,      KC_TILD,
    KC_NO,          KC_NO,        KC_TRNS,       MO(L_OTHER),   KC_TRNS,        KC_TRNS
  ),
	[L_OTHER] = LAYOUT_split_3x6_3(
    KC_F1,          KC_F2,        KC_F3,         KC_F4,         KC_F5,          KC_F6,                KC_F7,        KC_F8,        KC_F9,        KC_F10,       KC_F11,       KC_F12,
    KC_NO,          KC_NO,        KC_NO,         KC_NO,         KC_NO,          KC_NO,                KC_NO,        KC_KB_POWER,  KC_SLEP,      KC_NO,        KC_NO,        KC_NO,
    KC_NO,          KC_NO,        KC_NO,         KC_NO,         KC_NO,          KC_NO,                TG(L_NUMPAD), KC_NO,        KC_NO,        KC_NO,        KC_NO,        KC_NO,
    KC_NO,          KC_NO,        KC_TRNS,       KC_TRNS,       KC_NO,          KC_NO
  ),
	[L_NUMPAD] = LAYOUT_split_3x6_3(
    KC_NO,          KC_NO,        KC_NO,         KC_NO,         KC_NO,          KC_NO,                KC_MINS,      KC_7,         KC_8,         KC_9,         KC_PSLS,      KC_BSPC,
    TG(L_NUMPAD),   KC_NO,        KC_NO,         KC_NO,         KC_NO,          KC_NO,                KC_PLUS,      KC_4,         KC_5,         KC_6,         KC_PAST,      KC_NO,
